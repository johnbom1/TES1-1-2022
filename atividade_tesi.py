...
class Tela:
    ...
    def tela_atualizar(self):
        ...
        if contador > 1:
            ...
            self.btn_confirmar = tk.Button(self.top_atualizar, text='Confirmar Atualização', command=self.confirmar_atualiza)
    ...
    def confirmar_cadastro(self):
        ...
        if nome == '' or cpf == '' or email == '':
            messagebox.showinfo('Aviso', 'Todos campos são obrigatórios', parent=self.top_cadastro)
        else:
